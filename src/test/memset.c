...
Suite *s21_memset_suite(void) {
  ...
  TCase *tcase_core = tcase_create("s21_memset_test");
  ...
  tcase_add_test(tcase_core, memset_7);
  tcase_add_test(tcase_core, memset_8);
  tcase_add_test(tcase_core, memset_9);
  tcase_add_test(tcase_core, memset_10);
